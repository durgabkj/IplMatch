...
import java.util.Locale;
    ...
    public class predictionAdapter extends RecyclerView.Adapter<com.ottego.iplHub.predictionAdapter.MyViewHolder> {
        List<MatchModel> list;
        Context context;

        public predictionAdapter(Context context, List<MatchModel> list) {
            this.list = list;
        ...
        @Override
        public com.ottego.iplHub.predictionAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.today_match_layout, parent, false);
            return new com.ottego.iplHub.predictionAdapter.MyViewHolder(view);
        ...
        @Override
        public void onBindViewHolder(@NonNull com.ottego.iplHub.predictionAdapter.MyViewHolder holder, int i) {
        ...
        if( (model.live.equals("1")))
        {
           holder.llPrediction.setVisibility(View.VISIBLE);
           holder.tvPrediction.setText(model.prediction);
        }
        else {
            holder.tvPrediction.setText("Prediction not available right now");
        }
